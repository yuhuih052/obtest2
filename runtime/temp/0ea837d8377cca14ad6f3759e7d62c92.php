...
layui.use('table', function(){
  ...
  table.render({
    elem: '#demo'
    ,height: 312
    ,url: "<?php echo url('Cfi/sellCfi2'); ?>" //数据接口
    ...
    ,cols: [[ //表头
      ...
      ,{field: 'sell_a', title: '总挂卖量', width:150, sort: true}
      ,{field: 'sell', title: '剩余未成交', width:150} 
