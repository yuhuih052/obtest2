<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:70:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\ep\sell_list.html";i:1596782910;s:64:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\layout.html";i:1585716400;s:68:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\layout\top.html";i:1585716400;s:71:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\layout\header.html";i:1595917326;s:71:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\layout\footer.html";i:1585716400;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<table class="table table-bordered" style="width: 48%;">
    ...
    <tr>
        ...
        <td><?php if($vo['flag'] == 1): ?>等待打款
            ...
            <?php elseif($vo['flag'] ==5): ?>申请仲裁
            <?php endif; ?>
        </td>
            <td>

                <?php if($vo['flag'] == 1): ?>等待买家付款
                <?php elseif($vo['flag'] ==2): ?>
                <form action="<?php echo url('ep/comfirm_money'); ?>" method="post">
                <input hidden name="id" value="<?php echo $vo['id']; ?>">
                <input type="submit" value="确认收款"></input>
                </form>
                <form action="<?php echo url('ep/arb'); ?>" method="post">
                    <input hidden name="id" value="<?php echo $vo['id']; ?>">
                    <input type="submit" value="申请仲裁">
                </form>
                <?php elseif($vo['flag'] ==3): ?>完成交易
                <?php elseif($vo['flag'] ==6): ?>交易关闭,订单被取消
                <?php elseif($vo['flag'] ==-4): ?>拒绝交易
                <?php elseif($vo['flag'] ==-1): ?>仲裁
                <?php elseif($vo['flag'] ==5): ?>仲裁结果可到匹配订单界面查看
                <?php endif; ?>
...
<script>
    function comfir(){
        document.form.action="<?php echo url('Ep/comfirm_money'); ?>";
