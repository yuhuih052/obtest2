<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\user\chongzhi.html";i:1595917383;s:64:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\layout.html";i:1585716400;s:68:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\layout\top.html";i:1585716400;s:71:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\layout\header.html";i:1595917326;s:71:"D:\phpstudy_pro\WWW\obtest2\public/../app/index\view\layout\footer.html";i:1585716400;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<form action="<?php echo url('user/chongzhi1'); ?>" method="post" class="form_single">
  <?php echo token(); ?>
    <div class="box" style="margin: 40px;">
      <div class="box-body">
              <label>输入充值额度</label><span>最小充值<?php echo $data['0']['recharge_min']; ?>,最大充值<?php echo $data['0']['recharge_max']; ?>,充值倍率<?php echo $data['0']['recharge_mult']; ?></span><br>
              
              <input class="form-control" name="request_chongzhi" placeholder="请输入100的倍数" value="" type="number">

      </div>
      <div class="box-footer">
        <button  type="submit" class="btn ladda-button ajax-post" data-style="slide-up" target-form="form_single">
    <span class="ladda-label"><i class="fa fa-send"></i> 充值</span>
</button>
