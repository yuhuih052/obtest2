<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpstudy_pro\WWW\obtest\public/../app/api\view\index\content_template.html";i:1585716400;}*/ ?>
<div id="project">
    <div class="pull-left">
...
<?php endif; if(!(empty($info['response_examples']) || (($info['response_examples'] instanceof \think\Collection || $info['response_examples'] instanceof \think\Paginator ) && $info['response_examples']->isEmpty()))): ?>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="error-examples-User-GetUser-0_3_0-0">
        <pre class="prettyprint language-json prettyprinted" data-type="json" style=""><code><?php echo $info['response_examples']; ?></code></pre>
      </div>
    </div>
