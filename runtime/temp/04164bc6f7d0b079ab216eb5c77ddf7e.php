...
<div align="center"><?php echo $list->render(); ?></div>
...
function get_members(event, treeId, treeNode, clickFlag) {
    ...
    $.ajax({
        url: "<?php echo url('getChildrenMembers2'); ?>",
