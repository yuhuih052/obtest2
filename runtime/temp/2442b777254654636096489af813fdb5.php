        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
                <label>头像图片</label>
                <br/>
                <?php echo widget('file/index', ['name' => 'head_img_id', 'value' => 0, 'type' => 'img']); ?>
            </div>
          </div>
